...
# Use REMOTE argocd-bootstrap module (generic, from upstream)
terraform {
  source = "${local.versions.locals.remote_modules}//argocd-bootstrap?ref=${local.versions.locals.modules_version}"
}
